                    ...
                    (errHash, resultHash) => {
                        ...
                        connection.query(
                            ...
                            (errLoc, rowsLoc, fieldsLoc) => {
                                ...
                                connection.query(
                                    "SELECT * FROM Locker WHERE LockerUserID = ? AND Availability = ?", [rows[0].UserID, false],
                                    (errLocker, rowsLocker, fieldsLocker) => {
                                        ...
                                        connection.query(
                                            "INSERT INTO Login(LoginUserID, RequestIP, RequestTime) values (?, ?, ?)", [rows[0].UserID, requestIp.getClientIp(req), dateTime],
                                            (errLog, resultLog) => {
